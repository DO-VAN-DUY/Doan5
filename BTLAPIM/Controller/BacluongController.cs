...
namespace Controllers
{
    ...
    {
        private IBacluongBusiness _productBusiness;
        private string _path;
        public BacluongController(IBacluongBusiness productBusiness, IConfiguration configuration)
        {
        ...
        [Route("hienthi")]
        [HttpGet]
        public IEnumerable<BacluongModel> GetDatabAll()
        {
        ...
        [Route("thembacluong")]
        [HttpPost]
        public BacluongModel Create([FromBody] BacluongModel model)
        {
        ...
        [Route("Suabacluong")]
        [HttpPost]
        public BacluongModel UpdateProduct([FromBody] BacluongModel model)
        {
